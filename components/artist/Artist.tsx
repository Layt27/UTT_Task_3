    ...
    return (
        <>
            <div className="relative w-full h-full overflow-hidden bg-cover bg-center">
                <BackgroundVideo />
                <div className="relative z-20 text-white p-5 sm:p-10">
                            ...
                            <div className="flex justify-between space-x-4 py-5">
                                <div className="flex items-center">
                                    <p className="text-center text-[7px] sm:text-xs md:text-sm lg:text-base xl:text-lg border rounded-sm p-3 bg-green-700 bg-opacity-70">
                                        Most streamed Indian female artist on
                                        Spotify in 2021, 2022 and 2023.
                                    </p>
                                </div>
                                ...
                                <div className="flex items-center">
                                    <p className="flex items-center text-center text-[7px] sm:text-xs md:text-sm lg:text-base xl:text-lg border rounded-sm p-3 bg-green-700 bg-opacity-70">
                                        Most streamed Indian female artist on
                                        Apple Music in 2021 and Amazon Music in
                                        2022.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col xs:max-md:text-center xs:max-md:items-center xs:max-md:space-y-4 md:flex-row md:justify-between md:space-x-10">
                                <div className="md:flex md:items-center lg:basis-2/3">
                                    <p className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl border rounded-sm p-3 bg-green-700 bg-opacity-70">
                                        Shreya Ghoshal, born on March 12, 1984,
                                        in Berhampore, West Bengal, is a
                                        celebrated Indian singer known for her
                                        wide vocal range and versatility.
                                        Growing up in Rawatbhata, Rajasthan, she
                                        began learning music at the age of four
                                        and received formal classical training
                                        from six. She gained recognition at
                                        sixteen by winning the TV singing
                                        reality show “Sa Re Ga Ma”, leading to
                                        her Bollywood playback debut in the film
                                        "Devdas" (2002) directed by Sanjay Leela
                                        Bhansali. Renowned as the "Queen of
                                        Dynamics", Ghoshal is considered one of
                                        the greatest vocalists of the Indian
                                        subcontinent.
                                    </p>
                                </div>
                                <Image
                            ...
                            <div className="flex flex-col xs:max-md:text-center xs:max-md:items-center xs:max-md:space-y-6 md:flex-row md:justify-between w-full md:max-xl:space-x-10">
                                ...
                                <div className="md:flex md:flex-col md:justify-center md:items-center">
                                    <ul className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl space-y-2 lg:space-y-5 xl:space-y-8 2xl:space-y-12 border rounded-sm p-3 bg-green-700 bg-opacity-70">
                                        <li>
                                            5 National Film Awards for Best
                                            Female Playback Singer
                                        </li>
                                        <li>
                                            7 Filmfare Awards, including the RD
                                            Burman Award for New Music Talent
                                        </li>
                                        <li>
                                            6 awards for Best Female Playback
                                            Singer
                                        </li>
                                        <li>
                                            9 Filmfare Awards South for Best
                                            Female Playback Singer
                                        </li>
